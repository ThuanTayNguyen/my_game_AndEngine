...
public class Level2_Activity extends SimpleBaseGameActivity {
    ...
    private String path="level2/level2.tmx";
...
//        this.mCAMERA.setBoundsEnabled(true);
        ...
        mScene.registerUpdateHandler(new TimerHandler(1f, true, new ITimerCallback() {
            ...
            public void onTimePassed(TimerHandler pTimerHandler) {
                ...
                if(time==0 && myScore<Score_nextlever){
                    ...
                    Intent intent =new Intent(Level2_Activity.this,Level3_Activity.class);
    ...
    public void onBackPressed() {
        Intent intent =new Intent(Level2_Activity.this,MenuGameActivity.class);
        startActivity(intent);
        finish();
        super.onBackPressed();
    }
    public  void luudiem(){
        try {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    AlertDialog.Builder  builder= new AlertDialog.Builder(Level2_Activity.this);
                    final EditText myEditText=new EditText(Level2_Activity.this);
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    try {
                                        ...
                                        editMyNameShared.putString("KEY_NAME",yourname+" (Level 2)");
                                        editMyScoreShared.putInt("KEY_SCORE",myScore);
                                        editMyScoreShared.commit();
                                        editMyNameShared.commit();
                                        Log.v("Gui","Đã gửi được" +yourname);
                                        Intent intent =new Intent(Level2_Activity.this,HighScoreActivity.class);
                                        startActivity(intent);
                                        finish();
